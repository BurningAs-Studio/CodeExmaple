...
namespace FAS.Players
{
	public class PlayerVisualEffects : MonoBehaviour
	{
		...
		[SerializeField] private ParticleSystem _bloodFlowingEffect;
		...
		public void PlayBloodFlowingEffect() => _bloodFlowingEffect.Play();
		
		public void StopBloodFlowingEffect() => _bloodFlowingEffect.Stop();
		
		public void PlayBloodShowerEffect() => _bloodShowerEffect.Play();
		
		public void StopBloodShowerEffect() => _bloodShowerEffect.Stop();
