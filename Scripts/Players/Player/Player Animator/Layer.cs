...
namespace FAS.Players.Animations
{
	public class Layer : IReadOnlyAnimatorLayer
	{
		...
		public void PlayAnim(int animHash, float nTime = 0) => Animator.Play(animHash, Index, 0);
		...
		public void UpdateLayerInfo() => Info = Animator.GetCurrentAnimatorStateInfo(Index);
	}
}