...
namespace FAS.Zombies
{
	public class ZombieAnimator : MonoBehaviour
	{
		...
		public const int DAMAGE_LAYER = 1;
		
		public const int DEATH_FORWARD_TYPE_INDEX = 0;
		public const int DEATH_BACKWARD_TYPE_INDEX = 1;
		public const int DEATH_RIGHT_TYPE_INDEX = 2;
		public const int DEATH_LEFT_TYPE_INDEX = 3;
		...
		{
			if (!IsLayerActive(DamageLayerInfo))
				_animator.Play(_takeDamageAnimHash, DAMAGE_LAYER, 0f);
		}
